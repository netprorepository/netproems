...
<div class="container-fluid">
    <div style="padding-bottom: 10px; margin-bottom: 20px;"><?= $this->Html->link(__(' '), ['controller' => 'Users', 'action' => 'newadmin'], ['class' => 'btn-circle btn-lg fa fa-plus float-right', 'title' => 'Add new teacher'])
?>
        <!-- Page Heading -->
