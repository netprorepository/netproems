                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Update Teacher Profile</h1>
                        </div>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    <?= $this->Form->control('country_id', ['label' => false, 'class' => 'form-control form-control-user2', 'options' => $countries, 'empty' => 'Select Country']) ?>

                                </div>
                                <div class="col-sm-4 mb-3 mb-sm-0">
                                    <?= $this->Form->control('state_id', ['label' => false, 'class' => 'form-control form-control-user2', 'options' => $states, 'empty' => 'Select State']); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <?= $this->Form->control('ccv', ['label' => 'Upload CV', 'type' => 'file', 'class' => 'form-control form-control-user2', 'placeholder' => 'Upload CV']); ?>
                                ...
                                <div class="col-sm-4">
                                    <?php
                                      $gender = ['Male' => 'Male', 'Female' => 'Female'];
                                      echo $this->Form->control('gender', ['options' => $gender, 'label' => 'Gender', 'class' => 'form-control form-control-user2', 'placeholder' => 'gender'])
                                    ?>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <?= $this->Form->control('subjects._ids', ['options' => $subjects, 'label' => 'Assign Subjects', 'empty' => 'Assign Subjects', 'class' => 'form-control form-control-user2']) ?>
                                </div>
                            </div>
                        </fieldset>
                        <br /> <br />
