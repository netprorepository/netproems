                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">New Message To Employees</h1>
                        </div>
                        <?= $this->Form->create() ?>
                        ...
                        <div class="col-sm-12">
                            <?= $this->Form->control('user._ids', ['label' => 'Select Employee(s)', 'options' => $teachers, 'id' => 'teacherstomail', 'class' => 'select2_multiple form-control']) ?>
