            ...
            <div class="p-5">
              <div class="text-center">
                ...
                <div class="form-group row">
                  <div class="col-sm-4 mb-3 mb-sm-0">
                    <?=  $this->Form->control('username', ['label' => false, 'class' => 'form-control form-control-user2',
                        'placeholder'=>'username','type'=>'email']);?>
                      </div>
                    
                     <div class="col-sm-4">
                  <?=$this->Form->control('password', ['label' => false, 'class' => 'form-control form-control-user2',
                    'id'=>  'exampleLastName','placeholder'=>'password','type'=>'password'])?>
                    
                  </div>
                    
                      <div class="col-sm-4">
                  <?=$this->Form->control('cpassowrd', ['label' => false, 'class' => 'form-control form-control-user2',
              ...
              <?= $this->Form->control('mname', ['label' => false, 'class' => 'form-control form-control-user2','placeholder'=>'middle name'])?>
                 ...
                 <div class="form-group row">
                  ...
                  <?= $this->Form->control('gender', ['options'=>$gender,'label' => false, 'class' => 'form-control form-control-user2','placeholder'=>'gender'])?>
